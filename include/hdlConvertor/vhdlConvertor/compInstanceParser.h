...
public:
	...
	static std::unique_ptr<std::vector<std::unique_ptr<hdlObjects::iHdlExprItem>>> visitPort_map_aspect(
	...
	static std::unique_ptr<std::vector<std::unique_ptr<hdlObjects::iHdlExprItem>>> visitGeneric_map_aspect(
