...
HdlNamespace * VhdlPackageHeaderParser::visitPackage_declaration(
	...
	iHdlExpr * name = VhdlLiteralParser::visitIdentifier(ctx->identifier(0));
...
HdlModuleDec * VhdlPackageHeaderParser::visitComponent_declaration(
