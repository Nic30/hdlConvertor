...
from hdlConvertor.hdlAst import iHdlExpr, HdlName, HdlBuiltinFn,\
    HdlContext, HdlModuleDec, HdlStmAssign, HdlStmProcess
from hdlConvertor.hdlAst._expr import HdlIntValue, HdlCall
...
def discover_stm_outputs_context(c: HdlContext):
    outputs = {}
    # :type _outputs: Dict[Tuple[HdlModuleDec, HdlStm], Set[HdlName]]
    for o0 in c.objs:
